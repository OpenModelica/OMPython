...
class ModelicaSystemCmd:
    ...
    def __init__(
        ...
        # 'override' argument needs special handling
...
class ModelicaSystem(ModelicaSystemBase):
    ...
    def _xmlparse(self, xml_file: OMCPath):
        ...
        # ModelicaSystem uses OMCPath to read text, then fromstring
    ...
    def getContinuous(
        ...
        if not self._simulated:
            return super().getContinuous(names)
...
class ModelicaSystemDoE:
    ...
    """
    # Dictionary keys used in simulation dict
