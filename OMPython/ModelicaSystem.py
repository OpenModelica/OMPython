...
class ModelicaSystem:
    ...
    def getContinuous(self, names=None):  # 4
        ...
        if not self._simulationFlag:
            ...
            if isinstance(names, str):
                return [self._continuouslist.get(names, "NotExist")]

            if isinstance(names, list):
                return [self._continuouslist.get(x, "NotExist") for x in names]
        else:
            if names is None:
            ...
            if isinstance(names, str):
                if names in self._continuouslist:
                    ...
                    return [self._continuouslist.get(names)]
                else:
    ...
    def getParameters(self, names: Optional[str | list[str]] = None) -> dict[str, str] | list[str]:  # 5
        ...
        if names is None:
            ...
            return [self._paramlist.get(names, "NotExist")]
        elif isinstance(names, list):
            return [self._paramlist.get(x, "NotExist") for x in names]
    ...
    def getSimulationOptions(self, names=None):  # 8
        ...
        if names is None:
            ...
            return [self._simulateOptions.get(names, "NotExist")]
        elif isinstance(names, list):
            return [self._simulateOptions.get(x, "NotExist") for x in names]
    ...
    def getLinearizationOptions(self, names=None):  # 9
        ...
        if names is None:
            ...
            return [self._linearOptions.get(names, "NotExist")]
        elif isinstance(names, list):
            return [self._linearOptions.get(x, "NotExist") for x in names]
    ...
    def getOptimizationOptions(self, names=None):  # 10
        ...
        if names is None:
            ...
            return [self._optimizeOptions.get(names, "NotExist")]
        elif isinstance(names, list):
            return [self._optimizeOptions.get(x, "NotExist") for x in names]
